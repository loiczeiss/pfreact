...
console.log(response.data.text);
    ...
    return (
       ...
       <div className="grid xl:w-[482px]  xl:h-[250px] h-[100px] bg-green-300 hover:bg-green-600 font-serif  justify-center	 content-center	">
          <a href="s"className="text-2xl" onClick={next}>Give it another chance you dotard</a>
        </div>
        <div className="grid xl:w-[482px]  xl:h-[250px] h-[100px] bg-green-300 hover:bg-green-600 font-serif  justify-center	 content-center	">
          <button className="text-2xl" onClick={next}>Give my all your knownledge you jolly boy</button>
        </div>   <div className="grid xl:w-[482px]  xl:h-[250px] h-[100px] bg-green-300 hover:bg-green-600 font-serif  justify-center	 content-center	">
